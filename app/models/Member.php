...
class Member
{
    ...
    // Listados
    public static function occupations() { return [/* ... tu lista ... */]; }
    public static function educationLevels() { return ['', 'Sin escolaridad','Primaria','Secundaria','Preparatoria/Bachillerato','Técnico','Licenciatura','Maestría','Doctorado','Otro']; }
    public static function bloodTypes() { return ['', 'A+','A-','B+','B-','AB+','AB-','O+','O-','No sabe']; }
    public static function maritalStatuses() { return ['', 'Soltero/a','Casado/a','Unión libre','Divorciado/a','Viudo/a','Separado/a']; }
    public static function genders() { return ['', 'Femenino','Masculino']; }
    ...
    public function save()
    {
        ...
        $sql = "INSERT INTO members
            (nombres, apellido_paterno, apellido_materno, edad, curp, bautizado, cobertura, nivel_academico,
            fecha_conversion, fecha_nacimiento, ocupacion, cursos, iglesia_anterior, razon_salida,
            talentos_json, ministerios_json, correo, telefono, tipo_sangre, estado_civil, genero, created_at)
            VALUES
            (:nombres,:apellido_paterno,:apellido_materno,:edad,:curp,:bautizado,:cobertura,:nivel_academico,
            :fecha_conversion,:fecha_nacimiento,:ocupacion,:cursos,:iglesia_anterior,:razon_salida,
            :talentos_json,:ministerios_json,:correo,:telefono,:tipo_sangre,:estado_civil,:genero,NOW())";
    ...
    public function update()
    {
        ...
        $sql = "UPDATE members SET
            ...
            edad=:edad, curp=:curp, bautizado=:bautizado, cobertura=:cobertura, nivel_academico=:nivel_academico,
            fecha_conversion=:fecha_conversion, fecha_nacimiento=:fecha_nacimiento, ocupacion=:ocupacion, cursos=:cursos,
            iglesia_anterior=:iglesia_anterior, razon_salida=:razon_salida, talentos_json=:talentos_json,
            ministerios_json=:ministerios_json, correo=:correo, telefono=:telefono, tipo_sangre=:tipo_sangre,
    ...
    {
        $talentosArray = array_values(array_filter(array_map('trim', explode(',', $this->talentos))));
        return [
