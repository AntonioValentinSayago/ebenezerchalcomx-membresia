...
class Member {
    ...
    public static function occupations() {
        return [
            ...
            'Biólogo/a','Bombero','Cajero/a','Carpintero/a','Chef','Chofer','Científico/a','Comerciante',
            'Comunicólogo/a','Contador/a','Costurero/a','Dentista','Desarrollador/a de software','Diseñador/a gráfico',
            'Docente/Profesor/a','Electricista','Enfermero/a','Entrenador/a','Estudiante','Farmacéutico/a',
            'Fotógrafo/a','Gerente','Ingeniero/a civil','Ingeniero/a industrial','Ingeniero/a sistemas',
            'Inspector/a','Jardinero/a','Jornalero/a','Mecánico/a','Médico/a','Mesero/a','Músico/a','Panadero/a',
            'Pastor/a','Peluquero/a','Periodista','Pescador/a','Plomero','Policía','Psicólogo/a','Publicista',
            'Recepcionista','Repartidor/a','Soldador/a','Técnico/a','Traductor/a','Vendedor/a','Veterinario/a',
            'Ama de casa','Otro'
        ];
    }
