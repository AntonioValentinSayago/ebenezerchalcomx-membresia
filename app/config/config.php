 ...
 */
define('DB_HOST', 'localhost');
define('DB_NAME', 'u735483186_ebenezerchalco');
define('DB_USER', 'u735483186_ebenezerchalco');
define('DB_PASS', '=SymfKiL#GI5');
...
define('BASE_URL', 'https://ebenezerchalcomx.site/public');
