      ...
      <div class="row g-0">
        ...
        <div class="col-lg-5 d-none d-lg-block" style="
          ...
          <div class="p-4 p-lg-5">
            ...
            <p class="opacity-75">Completa la información para <?= $isEdit ? 'editar el' : 'registrar un' ?> miembro.</p>
            ...
            <form method="post" action="<?= $action ?>" class="needs-validation" novalidate>
              ...
              <div class="row g-3" style="font-weight: bold;">
                ...
                <div class="col-md-6">
                  ...
                  <input required name="fecha_nacimiento" type="date" class="form-control" value="<?= $val('fecha_nacimiento') ?>">
                </div>
                <div class="col-md-3">
